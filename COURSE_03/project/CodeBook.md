...
### Variable notes
***while the orignial dataset had 561 variables our anlaysis was interested in only those variables that were associated with the mean or standard deviation***
- see [features](features.csv) for list of all variables
